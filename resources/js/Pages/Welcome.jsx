            ...
            <div className="flex justify-center flex-wrap max-w-7xl p-5 mt-2 sm:mt-6 sm:items-center">
                ...
                <div className="relative mx-auto space-y-8 p-3">
                    <h1 className='text-gray-900 font-bold text-3xl lg:text-5xl'>
                        Create your personal events and invite your friends nearby.
                    </h1>
                    <p className='text-gray-800 font-semibold text-lg'>
                        Discover upcoming local events and outdoor activites in your city <br/> and nearby
                        places and get interesting event recommendations.
                    </p>
                ...
                <div className='absolute top-0 -right-5 w-64 h-64 peach-gradient rounded-full
                 mix-blend-multiply filter blur-xl opacity-60'></div>
                <div className='absolute bottom-10 left-10 w-52 h-52 peach-gradient rounded-full
                 mix-blend-multiply filter blur-xl opacity-60'></div>
                 <div className="relative m-8">
                    <div className="shadow-2xl rounded-3xl h-full">
                     <img src='/storage/img/Tickets.png' className='h-[400px] w-full relative'/>
                    </div>
                 </div>
                </div>
                </div>
                ...
                <div className='flex flex-wrap my-10 sm:px-8'>
                    ...
                    <div className="flex flex-col items-center sm:flex-row sm:justify-between">
                        <InfoCard label='Easy to work'
                        icon={<CheckCircle className='h-[22px] w-auto' color='#ff8552'/>}
                        content='We beleieve that an easy to use hassle-free experience is essential
                        to make your attendees satisfied'
                        />
                        <InfoCard label='Works on every device'
                         icon={<CheckCircle className='h-[22px] w-auto' color='#ff8552'/>}
                ...
                <div className="absolute z-[0] w-52 h-52 -right-[50px] rounded-full peach-gradient bottom-0
                opacity-30 filter blur-3xl lg:w-80 lg:h-80" />
                    <div className="flex flex-col justify-center items-center p-3 mb-5 z-[1]">
                       ...
                       Discover upcoming nearby events and places, outdoor activites and get interesting
                       event recommendations.
                        </p>
                    </div>
                    <div className="flex flex-col items-center sm:flex-row sm:justify-between z-[1]">
                        <div className=''>
                        <InfoCard label='Create Event'
                        cardStyle='sm:text-right' headerStyle='sm:flex-row-reverse'
                        content='Create your own events in minutes, and it becomes instantly available on both
                        major mobile platforms, IOS and Android.'/>
                        <InfoCard label='Discover nearby events and activities'
                        cardStyle='sm:text-right' headerStyle='sm:flex-row-reverse'
                        ...
                        <img src='/storage/img/Tickets.png' className='h-full w-auto'/>
                        </div>
                        </div>
                        <div className=''>
                        <InfoCard label='Notification'
                        content='Create your own events in minutes, and it becomes instantly available on both
                        major mobile platforms, IOS and Android.'/>
                        <InfoCard label='Buy event tickets'
                        content='Create your own events in minutes, and it becomes instantly available on both
                        major mobile platforms, IOS and Android.'/>
                        </div>
                    </div>
